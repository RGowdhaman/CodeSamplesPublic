...
package view
{
	 ...
	 */	
	{CStringUtils.InitEnumConstants(ViditaFoodFindingStrategy);} 
	 ...
	 * such as for a <code>ViditaFoodFindingStrategy<code> class.
	 * 
	 * <p><u>REVISIONS</u> : <br> 
	 ...
	 *
	 */
	public class ViditaFoodFindingStrategy extends Enum
	{		
		...
		//PUBLIC CONST
		public static const RANDOM_AND_UNTARGETED 		: ViditaFoodFindingStrategy = new ViditaFoodFindingStrategy ();   
		public static const CLOSEST_AND_UNTARGETED 		: ViditaFoodFindingStrategy = new ViditaFoodFindingStrategy ();  	 
	}
}